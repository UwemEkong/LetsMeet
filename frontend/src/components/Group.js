    ...
    return (
        <div style={{ borderTop: "2px solid gray", marginBottom: "20px" }} className="container">
            <div style={{marginTop:"20px"}} className="row">
                <div style={{marginTop:"20px",height:"200px",border:"4px solid black", borderRadius: "10px",backgroundImage:`url(${image_url})`, backgroundSize:"contain", backgroundRepeat:"no-repeat", backgroundPosition:"center"}} className="col-2">
                </div>

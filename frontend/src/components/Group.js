    ...
    return (
        <div onClick={update} style={{ borderTop: "2px solid gray", marginBottom: "20px", cursor: "pointer" }} className="container">
            <div style={{marginTop:"20px"}} className="row">
                <div style={{marginTop:"20px",height:"200px",width:"200px",border:"4px solid black", borderRadius: "10px",backgroundImage:`url(${group.image_url})`, backgroundColor: getColor(), backgroundSize:"contain", backgroundRepeat:"no-repeat", backgroundPosition:"center"}} className="col-2">
                </div>
